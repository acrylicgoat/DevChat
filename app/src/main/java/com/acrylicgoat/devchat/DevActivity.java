...
import com.acrylicgoat.devchat.adapter.DevListAdapter;
...
public class DevActivity extends Activity
{
    ...
    public void onCreate(Bundle savedInstanceState) 
    {
        ...
        aBar = getActionBar();
        aBar.setTitle(getString(R.string.devactivity_title));
    ...
    private void saveDeveloper(String name)
    {
        ...
        if (length == 0) 
        {
            Toast.makeText(this, getString(R.string.no_name_msg), Toast.LENGTH_SHORT).show();
            return;
        }
